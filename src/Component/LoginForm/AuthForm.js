...
export default function AuthForm() {
  ...
  const submitHandler = (event) => {
    ...
    if (enteredPassword === confirmPassword) {
      ...
      if (isLogin) {
        url =
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAeRmO4BXGJNletqU7xCcI6eXmml3b0MFQ";
      } else {
        url =
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAeRmO4BXGJNletqU7xCcI6eXmml3b0MFQ";
      }
      fetch(url, {
        method: "POST",
        body: JSON.stringify({
      ...
      fetch(
        "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAeRmO4BXGJNletqU7xCcI6eXmml3b0MFQ",
        {
          method: "POST",
